 ...
 * </editWidget>
 *
 * @property-read boolean $allow_null
 * @property-read boolean $calendar_popup
 * @property-read string  $display_format
 * @property-read string  $field_format
 * @property-read boolean $field_iso_format
 */
class DateTimeConfig extends Project\Qgis\BaseQgisObject
{
