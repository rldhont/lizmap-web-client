 ...
 * @property-read string $referencingLayer
 * @property-read string $referencingField
 * @property-read string $referencedLayer
 * @property-read string $referencedField
...
class ProjectRelation extends BaseQgisXmlObject
{
    ...
    static protected $qgisLocalName = 'relation';
